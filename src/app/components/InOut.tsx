        ...
        <div className="flex flex-col w-2/3">
            ...
            <div className="flex justify-between bg-white h-28 rounded-full drop-shadow-xl divide-x-2">
                <div className="flex flex-col ml-[3.5rem] p-0  w-1/4">
                    ...
                    <input className="h-8 text-2xl my-0" type="text" placeholder="주차장 검색"></input>
                </div>
                ...
                <button className="flex items-center justify-center bg-orange-400 w-[5.5rem] rounded-full m-3 ">
